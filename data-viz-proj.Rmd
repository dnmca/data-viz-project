...
ggsave("visualizations/mnc_map.png", last_plot(), width = 10, height = 10)
```
...
#ggsave("visualizations/mismatched.png", last_plot( ), width = 14)
```
...
grouped_by_status %>% 
  ...
  theme(
    ...
    axis.text = element_text(family = "Ubuntu Mono", color = "black"),
    plot.title = element_text(family = "Ubuntu Mono", size = 10),
    plot.margin = unit(c(2,2,2,2), "cm")
  ) + 
  ylab("kg/day") +
